...
app.config['MAIL_USERNAME'] = 'elisabnethlozano790@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'kpcffkwuacrvxiks'  # Your Gmail password or App Password
