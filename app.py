...
app.config['MAIL_USERNAME'] = 'youandi2geda1@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'hwxyubwsxfdzzkmv'  # Your Gmail password or App Password
