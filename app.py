...
app.config['MAIL_USERNAME'] = 'ddcarter000247@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'wclxuyehwumueoiy'  # Your Gmail password or App Password
